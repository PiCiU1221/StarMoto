...
public class AdvertController {
    ...
    @GetMapping
    public ResponseEntity<?> getAllAdverts(@ModelAttribute Optional<AdvertFilterDTO> advertFilterDTO,
                                           @RequestParam(defaultValue = "0") int page,
                                           @RequestParam(defaultValue = "10") int size) {
        List<AdvertResponseDTO> adverts = advertService.getAllAdverts(advertFilterDTO.orElse(new AdvertFilterDTO()), page, size);
