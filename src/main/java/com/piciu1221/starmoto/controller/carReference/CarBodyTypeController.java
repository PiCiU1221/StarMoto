...
import com.piciu1221.starmoto.service.carReference.CarBodyTypeService;
...
public class CarBodyTypeController {
    ...
    public ResponseEntity<?> getCarBodyTypes() {
        List<String> bodyTypes = carBodyTypeService.getAllBodyTypes();
