...
import com.piciu1221.starmoto.service.carReference.CarFeatureService;
...
public class CarFeatureController {
    ...
    @GetMapping("/features")
    public ResponseEntity<?> getCarFeatures() {
        List<String> features = carFeatureService.getAllFeatures();
